...
const isActive = (history, path) => {
  if (history.location.pathname === path) {
    return { color: '#808080', textDecoration: 'none' };
  } else {
        ...
        <Toolbar>
          ...
          <div className={classes.sectionDesktop}>
            <Link style={isActive(history, '/')} to='/'>
              <IconButton aria-label='Home' color='inherit'>
                <HomeIcon />
                <Typography noWrap>Accueil</Typography>
              </IconButton>
            </Link>
            ...
            <Link style={isActive(history, '/shop')} to='/shop'>
              <IconButton aria-label='Shop' color='inherit'>
                <StorefrontIcon />
                <Typography noWrap>Boutique</Typography>
              </IconButton>
            </Link>
            ...
            <Link style={isActive(history, '/cart')} to='/cart'>
              <IconButton aria-label='Cart' color='inherit'>
                ...
                <Typography noWrap>Panier</Typography>
              </IconButton>
            </Link>
            ...
            {isAuthenticated() && isAuthenticated().user.role === 0 && (
              ...
              >
                <IconButton aria-label='Dashboard' color='inherit'>
                  <DashboardIcon />
                  <Typography noWrap>Tableau de bord</Typography>
                </IconButton>
              </Link>
            )}
            ...
            {!isAuthenticated() && (
              <Fragment>
                <Link style={isActive(history, '/signin')} to='/signin'>
                  <IconButton aria-label='Signin' color='inherit'>
                    <AccountCircleIcon />
                    <Typography noWrap>S'identifier</Typography>
                  </IconButton>
                </Link>
                ...
                <Link style={isActive(history, '/signup')} to='/signup'>
                  <IconButton aria-label='Signup' color='inherit'>
                    <PersonAddIcon />
                    <Typography noWrap>S'inscrire</Typography>
                  </IconButton>
                </Link>
              </Fragment>
            )}
